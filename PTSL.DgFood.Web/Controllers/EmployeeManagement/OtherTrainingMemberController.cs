...
{
    [SessionAuthorize]
    public class OtherTrainingMemberController : Controller
    {
        ...
        public OtherTrainingMemberController()
        {
        ...
        {
            var returnResponse = _OtherTrainingMemberService.List();
        ...
        public ActionResult Details(int? id)
        {
            ...
            (ExecutionState executionState, OtherTrainingMemberVM entity, string message) returnResponse = _OtherTrainingMemberService.GetById(id);
            return View(returnResponse.entity);
        }
        ...
        {
            OtherTrainingMemberVM entity = new OtherTrainingMemberVM();
       
            return View(entity);
        }
        // POST: Category/Create
        [HttpPost]
        public ActionResult Create(OtherTrainingMemberVM entity)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    (ExecutionState executionState, OtherTrainingMemberVM entity, string message) returnResponse = _OtherTrainingMemberService.Create(entity);
        ...
        [HttpPost]
        public ActionResult Edit(int id, OtherTrainingMemberVM entity)
        {
            try
            {
                entity.IsActive = true;
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (id != entity.Id)
                    {
                        return RedirectToAction(nameof(OtherTrainingMemberController.Index), "Category");
                    }
                    entity.UpdatedAt = DateTime.Now;
                    (ExecutionState executionState, OtherTrainingMemberVM entity, string message) returnResponse = _OtherTrainingMemberService.Update(entity);
                    Session["Message"] = returnResponse.message;
                    Session["executionState"] = returnResponse.executionState;
        ...
        {
            (ExecutionState executionState, string message) CheckDataExistOrNot = _OtherTrainingMemberService.DoesExist(id);
            ...
            //}
            (ExecutionState executionState, OtherTrainingMemberVM entity, string message) returnResponse = _OtherTrainingMemberService.Delete(id);
            if (returnResponse.executionState.ToString() == "Updated")
            {
        ...
        [HttpPost]
        public ActionResult Delete(int id, OtherTrainingMemberVM entity)
        {
            try
            {
                // TODO: Add update logic here
