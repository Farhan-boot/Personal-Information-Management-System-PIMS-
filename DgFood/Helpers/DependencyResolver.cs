...
using PTSL.GENERIC.Business.Businesses.Implementation.EmployeeManagementEntity;
...
namespace PTSL.DgFood.Api.Helpers
{
    public static class DependencyResolver
    {
        ...
        private static void AddScopedForBusiness(IServiceCollection services)
        {
            ...
            services.AddScoped<IUniversityInformationBusiness, UniversityInformationBusiness>();
            services.AddScoped<IUnionBusiness, UnionBusiness>();
            services.AddScoped<ITrainingPlanBusiness, TrainingPlanBusiness>();
            services.AddScoped<IOtherTrainingMemberBusiness, OtherTrainingMemberBusiness>();
            services.AddScoped<IEmployeePostingDetailsBusiness, EmployeePostingDetailsBusiness>();
        }
        ...
        private static void AddScopedForService(IServiceCollection services)
        {
            ...
            services.AddScoped<IUniversityInformationService, UniversityInformationService>();
            services.AddScoped<IUnionService, UnionService>();
            services.AddScoped<ITrainingPlanService, TrainingPlanService>();
            services.AddScoped<IOtherTrainingMemberService, OtherTrainingMemberService>();
            services.AddScoped<IEmployeePostingDetailsService, EmployeePostingDetailsService>();
        ...
        private static void AddScopedForRepository(IServiceCollection services)
        {
            ...
            services.AddScoped<IPermanentAddressRepository, PermanentAddressRepository>();
            ...
            services.AddScoped<IUniversityInformationRepository, UniversityInformationRepository>();
            services.AddScoped<IUnionRepository, UnionRepository>();
            services.AddScoped<ITrainingPlanRepository, TrainingPlanRepository>();
            services.AddScoped<IOtherTrainingMemberRepository, OtherTrainingMemberRepository>();
            services.AddScoped<IEmployeePostingDetailsRepository, EmployeePostingDetailsRepository>();
