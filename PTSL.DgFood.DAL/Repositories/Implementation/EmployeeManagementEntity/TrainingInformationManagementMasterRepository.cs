...
namespace PTSL.DgFood.DAL.Repositories.Implementation
{
        ...
        public class TrainingInformationManagementMasterRepository : BaseRepository<TrainingInformationManagementMaster>, ITrainingInformationManagementMasterRepository
        {
            public TrainingInformationManagementMasterRepository(
