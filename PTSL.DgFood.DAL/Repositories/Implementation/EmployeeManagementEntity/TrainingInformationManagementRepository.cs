...
namespace PTSL.DgFood.DAL.Repositories.Implementation
{
        ...
        public class TrainingInformationManagementRepository : BaseRepository<TrainingInformationManagement>, ITrainingInformationManagementRepository
        {
            public TrainingInformationManagementRepository(
