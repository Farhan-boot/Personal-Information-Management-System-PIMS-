...
namespace PTSL.DgFood.Api.Migrations
{
    ...
    [Migration("20231220111938_CalculationMethodUnderBanglaNameAdd")]
    partial class CalculationMethodUnderBanglaNameAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.EmployeeManagementEntity.EmployeeInformation", b =>
                {
                    ...
                    b.Property<string>("BcsBatchNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("BcsDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("BcsOrderNo")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<long?>("FreedomFighterInformationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.EmployeeManagementEntity.EmployeePostingDetails", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.Property<long?>("DesignationTypeId1")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EmployeePostingDetails","Employee");
                });
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.EmployeeManagementEntity.OtherTrainingMember", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("OtherTrainingMember","Employee");
                });
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.EmployeeManagementEntity.TrainingPlan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.Property<string>("InstructorOrConsultant")
                    ...
                    b.Property<string>("PossibleTrainingWorkshopTopics")
                        .HasColumnName("PossibleTrainingWorkshopTopics")
                        .HasColumnType("nvarchar(1000)");

                    b.Property<DateTime?>("ProbableEndDate")
                        .HasColumnName("ProbableEndDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ProbableStartDate")
                    ...
                    b.ToTable("TrainingPlan","Employee");
                });
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.CalculationMethod", b =>
                {
                    ...
                    b.Property<string>("CalculationMethodNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.DesignationClass", b =>
                {
                    ...
                    b.Property<string>("DesignationClassNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.EmployeeType", b =>
                {
                    ...
                    b.Property<string>("EmployeeTypeNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.GradationType", b =>
                {
                    ...
                    b.Property<string>("GradationTypeNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.JobCategory", b =>
                {
                    ...
                    b.Property<string>("JobCategoryNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.PostResponsibility", b =>
                {
                    ...
                    b.Property<string>("PostResponsibilityNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.PresentStatus", b =>
                {
                    ...
                    b.Property<string>("PresentStatusNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.SpecialHolydaySetup", b =>
                {
                    ...
                    b.Property<string>("SpecialHolydaySetupNameBn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.TrainingManagementType", b =>
                {
                    ...
                    b.Property<int>("SpecialTrainingType")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TrainingPlanType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.GeneralSetup.Union", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.EmployeeManagementEntity.EmployeePostingDetails", b =>
                {
                    ...
                    b.HasOne("PTSL.DgFood.Common.Entity.GeneralSetup.DesignationClass", "DesignationClass")
                        .WithMany("EmployeePostingDetails")
                        .HasForeignKey("DesignationClassId")
                        .OnDelete(DeleteBehavior.ClientCascade);
                    ...
                    b.HasOne("PTSL.DgFood.Common.Entity.GeneralSetup.Designation", "DesignationType")
                        .WithMany()
                        .HasForeignKey("DesignationTypeId1");
            ...
            modelBuilder.Entity("PTSL.DgFood.Common.Entity.EmployeeManagementEntity.PermanentAddress", b =>
                {
                    ...
                    b.HasOne("PTSL.DgFood.Common.Entity.GeneralSetup.Union", "Union")
                        .WithMany("PermanentAddresses")
