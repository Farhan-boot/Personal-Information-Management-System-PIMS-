...
namespace PTSL.DgFood.DAL.Repositories.Implementation
{
        ...
        public class TrainingManagementTypeRepository : BaseRepository<TrainingManagementType>, ITrainingManagementTypeRepository
        {
            public TrainingManagementTypeRepository(
