...
namespace PTSL.DgFood.DAL.Repositories.Implementation
{
        ...
        public class EmployeeInformationCountRepository : BaseRepository<EmployeeInformationCount>, IEmployeeInformationCountRepository
    {
            public EmployeeInformationCountRepository(
