...
namespace PTSL.DgFood.DAL.Repositories.Implementation
{
        ...
        public class RoutesLineStringJsonsRepository : BaseRepository<RoutesLineStringJsons>, IRoutesLineStringJsonsRepository
        {
            public RoutesLineStringJsonsRepository(
